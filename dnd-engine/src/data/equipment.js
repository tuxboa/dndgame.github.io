...
export const EQUIPMENT_TEMPLATES = {
  ...
  longsword: {
    ...
    icon: "⚔️",
    slot: "weapon",
    description: "+2 attack · 1d8 slashing · versatile (1d10)",
    bonuses: {
      attackBonus: 2,
      damageDie: 8,
      versatile: true,
    ...
    icon: "⚔️",
    slot: "weapon",
    description: "+3 attack · 1d8+1 slashing · versatile (1d10+1) · masterwork",
    bonuses: {
      attackBonus: 3,
      damageDie: 8,
      baseDmgBonus: 1,
  ...
  greataxe: {
    ...
    bonuses: { attackBonus: 2, damageDie: 12, twoHanded: true },
    slot: "weapon",
  ...
  battleaxe: {
    ...
    icon: "🔨",
    slot: "weapon",
    description: "+2 attack · 1d8 bludgeoning · versatile (1d10)",
    bonuses: {
      attackBonus: 2,
      damageDie: 8,
      versatile: true,
  ...
  spear: {
    ...
    icon: "🗡️",
    slot: "weapon",
    description: "+1 attack · 1d6 piercing · thrown · versatile (1d8) · reach",
    bonuses: {
      attackBonus: 1,
      damageDie: 6,
      versatile: true,
  ...
  quarterstaff: {
    ...
    icon: "🪄",
    slot: "weapon",
    description: "+1 attack · 1d6 bludgeoning · versatile (1d8)",
    bonuses: { attackBonus: 1, damageDie: 6, versatile: true, versatileDie: 8 },
    icon: "🏹",
    slot: "weapon",
