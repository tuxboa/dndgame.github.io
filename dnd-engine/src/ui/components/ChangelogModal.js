...
const CHANGELOG = [
  {
    month: "2025 Június",
    entries: [
      { type: "feat",    text: "Összetett kaland-motor: DM AI vezérelt narratíva OpenAI API-val" },
      { type: "feat",    text: "Taktikai harctérkép (20×14 rács, ős-sötétség, akadályok)" },
      { type: "feat",    text: "Halálos mentődobás rendszer (3 sikeres / 3 sikertelen)" },
      { type: "feat",    text: "Varázskönyv: ismert és előkészített varázslatok kezelése" },
      { type: "feat",    text: "Harcos osztály: Második Szél, Extra Támadás 5. szinten" },
      { type: "feat",    text: "Barbár osztály: Düh (Rage) rendszer, Vad Érzék" },
      { type: "feat",    text: "Bárd osztály: Bárd-inspiráció, harci / gyógyító varázslatcsomag" },
      { type: "feat",    text: "Ranger osztály: Hunter's Mark, Kedvezett Ellenség passzív" },
      { type: "feat",    text: "Szintléptetési rendszer XP-alapú ranglétrával (1-10. szint)" },
      { type: "feat",    text: "Leltárrendszer: felszerelés, lerakás, aranyvaluta" },
      { type: "feat",    text: "Kereskedő felület: NPC-viszony alapú árkorrekció (−20% / +20%)" },
      { type: "feat",    text: "Küldetésnapló: aktív, teljesített, kudarcba fulladt állapotok" },
      { type: "feat",    text: "Pihenőrendszer: rövid + hosszú pihenő, Életerő Kocka" },
    ],
  },
  {
    month: "2025 Július — Taktikai frissítés",
    entries: [
      { type: "feat",    text: "Ős-sötétség (Fog of War) láthatóság rácshoz kötött számítással" },
      { type: "feat",    text: "Akadályok ütközésdetekciója mozgáskor" },
      { type: "feat",    text: "Íjász-ívszakasz animáció (távolsági harc)" },
      { type: "feat",    text: "Sokoldalú fegyverek: Hosszúkard, Csatabárd, Háborús kalapács, Dárda, Vándorbot" },
      { type: "feat",    text: "Repülő/Reach fegyver-tartomány (dárda: 2 mezős elérési távolság)" },
      { type: "feat",    text: "Bárd 9. szint: Mágikus Titkok — bármely osztály varázslata megtanulható" },
      { type: "fix",     text: "baseDmgBonus (Kapitány Hosszúkardja +1) most helyesen alkalmazódik" },
      { type: "fix",     text: "Ellenség előny/hátrány: prone & vakított feltételek javítva" },
      { type: "fix",     text: "Halál-mentődobás UI időzítési probléma kijavítva" },
      { type: "balance", text: "Koncentrációs varázslatok (Áldás, Hitalap Pajzs) megfelelően törlésre kerülnek" },
      { type: "ui",      text: "NPC viszony jelvény a kereskedő felületen (😊 / 😠 + ár delta)" },
      { type: "ui",      text: "Rang- és Haladás Modal: kalandkörök, rangszintek, haladási sáv" },
      { type: "ui",      text: "Statisztika Radar Chart: hatszögű SVG pók-diagram a hat képességhez" },
      { type: "ui",      text: "RPG Navigációs sáv: LELTÁR · VARÁZSLATOK · VARÁZSKÖNYV · ÁLDÁSOK" },
      { type: "ui",      text: "Hogyan játssz? Accordion: 9 összecsukható szekció" },
      { type: "ui",      text: "Changelog Timeline Modal (ez a képernyő!)" },
      { type: "system",  text: "Vite 5 + ES modulok, GitHub Pages automatikus telepítés" },
    ],
  },
];
...
const TYPE_META = {
  ...
  balance: { label: "EGYENSÚLY",color: "#5b9abf", bg: "rgba(91,154,191,0.12)" },
